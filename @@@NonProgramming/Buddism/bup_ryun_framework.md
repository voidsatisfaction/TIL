...
- 본질 통찰의 중요성
- 경제학적 관점
  - **나의 선택에는 언제나 카르마(업보)가 따르는데, 그 업보를 고려해서 충분이 나에게 있어서 이득인지 생각해봐야 한다.**
  - 이는 고전 경제학의 효용이론과 같다.
  - **깨닫지 못한 사람은 합리적으로 효용을 고려하지 못한다. 그저 선택에 따른 좋은것만을 흡수하려 한다.**
- 확률적 관점
  - 세상에 무조건 이라는 것은 없다. 우리는 다만 우리가 원하는 대로 되도록 확률을 높일 수 있을 뿐
- 끊임없는 탐구정신
  - 법륜 스님은 본래 과학자적 성격을 띄고 있어서 언제나 궁금한것은 직접 탐구해보신다고 한다.
  - 예를들어, 결혼 한 사람들이 도대체 왜 싸우게 되는지, 왜 사랑하는 사람들끼리 결혼해서 불행하게 되는 경우도 존재하는지에 대해서도 처음에는 이해하지 못했으나, 많은 사람들이 질문하는 것을 보고 직접 탐구하였다고 하신다.
  - 아이의 교육에 관한 내용을 포함하여 정말 대단하시다고 생각한다.
  - **본질에 대한 탐구 정신을 정말 본받을 만 하다.**
- 나의 문제(깨달음의 문제) vs 타인의 문제(수행의 문제)
  - 나의 문제는 지금 여기서 깨달으면 됨
    - 왜냐하면 나만 깨달으면 문제는 존재하지 않는 것이 되므로
    - 결국 문제 역시 시비이므로, 시비는 내가 만들어낸 허상임을 깨달으면 됨
  - 타인의 문제는 타인을 감사히 여기거나 속죄하는 108베 수행이 필요
    - 왜냐하면 타인의 문제는 내가 깨닫는 것도 필요하지만, 타인은 변하지 않을것이므로 그것에 대한 내성이 필요하기 때문에.

## 비유

- **돈을 빌렸으면 갚아야 함**
  - 사람들은 돈은 빌리고 싶으나, 갚고싶지는 않아함
  - 하지만 그것은 도리에 어긋난 일이므로, 자신이 돈을 빌리는 선택을 했다면 값을 생각을 해야함
- **뜨거운 물이 담긴 컵**
  - 사람들은 컵이 뜨겁다고 말하면서 그것을 놓지 않는다. 그렇다는 것은 아직 그것을 잡을만한 여력이 있다는 것을 의미하거나, 그 컵을 잡는것에 너무나도 집착하고 있다는 것을 의미
- **선물상자 속 쓰레기**
  - 타인에게서 욕지거리를 받고 그것에 트라우마가되어 계속 그것이 생각나서 괴로운 사람은, 선물상자를 받았는데 그 안에 있는 쓰레기를 계속 간직해두고 바라보면서 괴로워하는 것과 같다.
- **계속되는 과거의 영화**
  - 트라우마가 있는 사람은, 머리속의 영화관에서 계속 같은 영화를 반복하는것과 같으며, 그것으로 부터 나와야 한다.
- **단골 구멍가게와 대형마트**
  - 절에도 가고 싶고 성당에도 가고 싶은 경우 어떻게 해야할까요?
  - 단골 구멍가게가 있는데, 새로 대형마트가 생겼다고 하면 어떻게 할 것인가?
    - 어디에 가든 자신의 자유
    - 그래서 절에 가도 성당에 가도 상관 없다.
    - 다만 단골 가게에 가서 대형마트가 싸다고 얘기하면 가게 주인이기분이 상하고, 대형마트가서 단골 구멍가게가 인심이 좋다고 하면 가게 주인이 기분이 기분이 상한다.
    - 그러므로 어딜가서든 다른곳 다는다고 얘기는 하지 말고 가는 것이 좋다.
- **바가지를 거꾸로 들고 있는 사람**
  - 관음보살님이 와도 구제할 수 없는 사람이 있음
  - 그것은 바가지를 거꾸로 들고 있는 사람이다.
    - 비가 아무리 내린다고 해도 바가지를 거꾸로 들고 있으면 물을 담을 수 없다
    - 그러니까 잔소리를 했을 떄, "알았다고!!!" 라며 화를 내는 사람은 이미 바가지를 거꾸로 들고 있는 사람이므로 잔소리를 할 필요가 없다.
    - 저 알았다고는 "듣기 싫다" 라는 뜻이다.

## 공리

![](./images/buddism_framework.png)

### 애초에 현실의 사상(事象)좋은 것도 없고 나쁜것도 없는, 시비할 수 없는 것이다(공) 그것에 좋고 나쁨을 부여하는 것은 우리의 인식 / 마음이다. 라는 깨달음
...
- 깨달음이란
  ...
  - **현실의 상황에 의거하여 일어난 자신의 마음상태가 모순적이라는 것을 파악하는 것**
    ...
    - **이럴때는 자신의 마음상태가 일어났다는 것을 깨닫고, 나의 마음의 물결이 일으키게 된 본질을 추구하면 괴로워하지 않아도 되는 일이라는 것을 알게 됨**
    - 비유하자면, "자신의 마음" 이라는 함수가 정의역인 현실 상황, 치역인 자신의 마음상태를 매칭시켜준다고 일반인은 생각하지만 애초에 정의역에 대한 본질 인식이 잘못되었다는 것을 인식해야 함
    ...
    - 물론 input을 변화시켜도 함수의 결과값은 변하나, 함수 자체의 로직이 잘못되어있으면 다른 input이 들어왔을때도 괴로움를 반환할 가능성이 크다. 반대로 함수 자체의 로직이 잘 되어있으면 어떠한 input이 와도 에러를 발생시킬 가능성이 낮다. 오히려 새로운 효과를 얻을 수도 있다.
  - **타인이나 그냥 그러한 것을 바꾸는 것은 어렵다. 그렇기 때문에 자신의 마음이 괴로울때는 나의 인식 / 마음이 모순적이라는 것을 깨달아서 마음의 안식을 얻는다. 물론 이렇게 괴로워하는 사람들을 줄이기 위한 사회적 개선 역시 필요하다.**
  - 깨달음이 쉽다고 주장하는 이유는, 나만 변화하면 되기 때문이다. 타인을 변화시키는 것은 거의 불가능에 가깝다.
  - 불교에서의 지혜란, **본질을 꿰뚫는 힘** 을 의미한다.

### 누구나 어떤상황에 처해있던 행복할 권리가 있다
...
### 따라서 인간은 자신의 마음을 바꾸는것으로 누구나 행복하게 살 수 있다

- 자신에게 괴로움을 주는 어떠한 현상의 본질에 대해서 생각해보자
- 그 현상이 그러한 것은 본질적으로 어떤 의미를 갖는가?

## 보조 공리

### 세상의 모든 것은 확률적인 것이다.

- 내가 타인에게 살갑게 대하는 이유는, 그렇게 하면 타인이 나에게 무조건 살갑게 대하기 때문이 아님
  - **그렇게 하면 타인이 나에게 살갑게 대할 확률이 높아지기 떄문**
  - 세상에 절대적인 것은 없다.
- 진인사 대천명
  - 내가 최선을 다하는 것은 확률을 높이는 행위
  - 하늘의 뜻은 결과인데, 그것은 반드시 이루어진다고 할 수는 없다.

### 선택에는 책임이 따른다.

### 괴로움과 즐거움은 뗄레야 뗄 수 없으며, 괴로움이 없는 것을 행복이라 하면 고락의 윤회에서 벗어날 수 있다

## 분야별 예시

### 교육

- 어떻게 하면 법륜 스님처럼 항상 꺠어있을 수 있는가?
  - **항상 연구를 하자**
    - 사람들은 왜 부부가 되었는데 싸울까?
    - 어떻게 하면 좋은 팽이를 만들 수 있을까?
  - 창의성있는 아이로 키우기 위해서는
    - **주어진 상황을 부정적으로 보지 말고 어떠한 문제에 대해서 가설 / 검증의 프로세스를 반복하므로써, 언제나 연구를 하도록 한다**
      - 지식을 외워서 쓰레기통에 버리지 말라. 즉, 좋은 성적에 연연하지 말라
      - e.g
        - 어떻게 하면 좋은 팽이를 만들 수 있을까?
        - 좋은 팽이를 사주지말고, 어떻게 하면 좋은 팽이를 만들 수 있는지 자신이 주체적으로 생각하도록 한다
    - **아이를 하나의 인격체로 대해서, 아이가 "리더로서" 주체적으로 세상의 지식을 배우고 적용할 수 있도록 함**
      - 사람을 어른으로 대하면 빨리 어른이 된다
...
- 현재 민원 처리 담당을 하고 있는데, 행패를 부리는 사람이 와서 마음을 힘들게 하는 문제
  ...
  - 행패를 부리는 사람은 기분나쁜 마음으로 경찰서까지 갔다가 다시와야하고 또, 돌을 찾아서 집어서 와야할 정도로 에너지를 많이 소비
    ...
    - 사실은 내가 더 편한 입장에 있다.
- 어떻게 하면 자기자신을 타인과 비교하거나 자기 비판에 빠지지 않을 수 있는가?
  - 자기자신을 너무 대단한 존재로 생각하지 말라.
    - 자신은 부처, 예수와 같은 성인이 아니다.
  - 그러므로 언제든지 실수할 수 있다.
  - 실수를 한 다음에 고치면 된다.
- 하느님 예수님 부처는 같다 라는 말은 무슨 뜻인가?
  - 검은 콩과 하얀 콩은 서로 같은가 다른가?
  - 검은 콩 하얀 콩을 무랑 비교했을때에는 같은 콩인가 다른 콩인가?
  - 콩과 무를 먹지 못하는 것과 비교하면 같은 음식인가 아닌가?
  - 즉, 하느님 예수님 부처가 같다는 것은 그 존재 자체가 똑같다 라는것이 아니고, 세상을 살아가는 지혜를 주는 성인으로서 같다는 것이다.
  - **결국 무엇이 같다 다르다 하는 것은 그것의 기준이 중요한 것이다.**
- 말 잘 듣지않고 나를 닮은 아이를 어떻게 가르쳐야 하는가?
  - 아이는 호통을 치면 마음에 상처를 입는다.
  - 대신 아이는 부모를 따라한다.
  - 그러므로 아이를 가르치기 위해서는 먼저 부모가 그것을 솔선수범해야 한다.
    - 아이가 행복하길 원하면 나부터 행복하는 것이 중요함
  - **아이는 부모의 거울**
- 이루어질 수 없는 사랑을 하고 있습니다. 그래서 내가 괴롭습니다.
  - 사랑은 본디 사랑을 하는것이지 그것으로 괴로울 것이 전연 없다.
  - 사랑으로 인해서 괴롭다면 그것은 사랑이 아니라 편집증이다.
  - 즉, 집착인 것이다.
- 아이는 어떻게 양육해야 하는가?
  - 적어도 3살 까지는 무슨 일이 있어도 엄마가 키워줘야 한다.
  - 아이가 잘 되기 위해서는 엄마의 심리가 안정되어야 한다.
    - 그래서 남편이 항상 아내가 근심이 없도록 잘 해주어야 한다.
  - 아이의 창의성을 키워주어야 한다.
    - 자신이 정답을 주려 하지말고, 생각을 확장시킬 수 있도록 유도해아한다. 질문.
    - 왜 그렇게 생각했어?
  - 아이가 자주성을 키울 수 있도록 해야한다.
    - 아이가 밥을 지어보도록
    - 아이가 빨래를 해 보도록
  - 20살이 지나면 성인이므로, 양육의 책임도 없고, 아이에게 더이상 자신의 의견을 강요해서는 안된다.
...
- 내가 아상에 사로잡히는 존재임을 인정하고 항상 자신을 점검해야 합니다.
  ...
  - "관음의 진신을 친견한다" 라는 것은 어떤 누구를 보는 것이 아니라 이런 과정을 통해서 자기의 모순을 자각하는 것이다.
...
- 관념적인 것을 벗어던지라고 스님은 말씀하시는데, 관념적 이라는 것은 무엇을 뜻하는 것입니까?
  - 아상을 말씀하시는 것일듯. 내가 옳다 하는 시비를 구별하는 마음
- 우리나라에게 있어서 "독도"라는 것은 영토에 포함이 되는 것인데 어찌 이것을 "독도"도 아니고 "다케시마" 도 아니라고 할 수 있습니까? 둘다 아니라면 영토적 개념에서는 어떻게 생각해야 합니까? 어디에인가는 포함이 되어야 하지 않겠습니까? 이것이 현실 아닙니까? 아상에서 벗어나야하지만 타인에게 아상에서 벗어나야한다고 주장하는 거 자체가 아상이 아닙니까?
  ...
  - 그러므로 애초에 도메인이 다른 레벨이다.
  - 그렇다고 독도를 다케시마라고 주장하는 사람들을 미워해서는 안된다.
