...
> 좋은 아키텍트는 다양한 도구들을 어떠한 타이밍에 사용할지를 정확히 알고, 행동을 할 때에는 과감한 가설검증의 프로세스를 반복해 나가야 할 것입니다. 처음부터 완벽한 솔루션이 아닌, 살아있는 솔루션, 즉, 점점 발달해가는 솔루션을 빠르게 개발해 나가야 합니다. 왜냐하면 우리는 세상에 대해서 잘 모르고, 세상은 계속 변화하기 때문입니다.
